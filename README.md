...
To install a minimal Fedora, download the Fedora Server minimal ISO from the official [Fedora Server download page](https://getfedora.org/en/server/download/).
